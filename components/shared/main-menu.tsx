...
const MainMenu = () => {
    return ( <ul className="flex flex-col lg:flex-row items-center gap-4 p-3">
        <li>
        ...
        <li>
            <Link href="#abot" className="py-2 px-4 border-b-2 border-transparent hover:border-primary transition-colors duration-300 text-white">
                About
            </Link>
        </li>
        <li>
